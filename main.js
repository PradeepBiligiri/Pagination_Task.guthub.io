...
//Createing Table using Array of Object
// buildTable(data);
...
//     col1.innerHTML = obj[i].id;
//     let col2 = document.createElement("td");
//     col2.innerHTML = obj[i].name;
//     let col3 = document.createElement("td");
//     col3.innerHTML = obj[i].email;
...
function displayTable(items, wrapper, rows_per_page, page) {
  ...
  for (let i = 0; i < paginatedItems.length; i++) {
    ...
    let row = document.createElement("tr");
    let col1 = document.createElement("td");
    col1.innerHTML = paginatedItems[i].id;
    let col2 = document.createElement("td");
    col2.innerHTML = paginatedItems[i].name;
    let col3 = document.createElement("td");
    col3.innerHTML = paginatedItems[i].email;
    row.append(col1, col2, col3);
...
function setPagination(items, wrapper, rows_per_page) {
  ...
  // To round of the number of page to display using Math.ceil
  // let page_count = items.length / rows_per_page;
...
function PaginationButton(page) {
  ...
  button.addEventListener("click", function () {
    current_page = page;
    displayTable(data, tbody, rows, current_page);
  });
  return button;
}

setPagination(data, pagination_element, rows);
// let Table = document.querySelector("#table");
// let Body = Table.querySelector("#body");
// let row = body.querySelector("#row");

// data.forEach((i) => {
//   let col1 = row.querySelector(".col1");
//   col1.innerHTML = i.id;
//   row.appendChild(col1);
// });

// data.forEach((j) => {
//   let col2 = row.querySelector(".col2");
//   col2.innerHTML = j.name;
//   row.appendChild(col2);
// });
// data.forEach((k) => {
//   let col3 = row.querySelector(".col3");
//   col3.innerHTML = k.email;
